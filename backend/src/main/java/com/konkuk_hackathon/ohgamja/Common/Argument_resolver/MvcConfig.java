...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtAuthInterceptor).addPathPatterns("/games");
        registry.addInterceptor(jwtAuthInterceptor).addPathPatterns("/games/random");
        ...
        registry.addInterceptor(jwtAuthInterceptor).addPathPatterns("/playlists/playlistInfo");
    }
